 ...
 *  The default value is the string returned by `[QMChatCollectionViewCellOutgoing cellReuseIdentifier]`.
 ...
 *  The default value is the string returned by `[QMChatCollectionViewCellOutgoing mediaCellReuseIdentifier]`.
 *  This value must not be `nil`.
 *
 *  @see QMChatCollectionViewCellOutgoing.
 *
 ...
 *  The default value is the string returned by `[QMChatCollectionViewCellIncoming cellReuseIdentifier]`.
 *  This value must not be `nil`.
 *
 ...
 *  The default value is the string returned by `[QMChatCollectionViewCellIncoming mediaCellReuseIdentifier]`.
 *  This value must not be `nil`.
 *
 *  @see QMChatCollectionViewCellIncoming.
 *
